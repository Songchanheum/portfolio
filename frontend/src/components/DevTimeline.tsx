...
import { FaBeer, FaUniversity, FaRegBuilding, FaBuilding} from 'react-icons/fa';
    ...
    <Box backgroundColor={isDark ? "gray.800" : "gray.300"} w="80%">
        <VerticalTimeline>
            ...
            >
              ...
              <h4 className="vertical-timeline-element-subtitle">정보통신공학과</h4>
              <p>
                안양대학교 정보통신공학과 졸업
              </p>
              <p>
            ...
            <VerticalTimelineElement
              ...
              icon={<GiHand />}
            >
              <h3 className="vertical-timeline-element-title">(주)카피앤패이스트</h3>
            ...
            <div onMouseOver={()=>setCnp1(true)} onMouseOut={()=>setCnp1(false)}>
            <VerticalTimelineElement
              className="vertical-timeline-element--work"
              date="2016.11 - 2018.11"
              contentStyle={{ background: 'rgb(237, 165, 169)', color: '#fff' }}
