...
function Profile() {
    ...
    return (
            ...
            >
                <Box alignSelf="center" px="16" py="16">
                    <Flex>
                        ...
                        <Text fontWeight="bold" color={isDark? "gray.200" : "gray.500"} fontSize="4xl" p={2}>
                            년차 개발자
                        </Text>
                    </Flex>
                    <Text align="center" fontSize="2xl" color="gray.400">2016.11 ~ 현재까지</Text>
                </Box>
                <Box alignSelf="center" px="16" py="16">
                    <Flex direction={isSmallScreen ? "row" : "column"}>
                        ...
                        <Text alignSelf="flex-end" fontWeight="bold" color={isDark? "gray.200" : "gray.500"} fontSize="4xl" p={2}>
                            졸업
                        </Text>
                    </Flex>
                    <Text align="center" fontSize="2xl" color="gray.400">정보통신공학과</Text>
                </Box>
                <Box alignSelf="center" px="16" py="16">
                    <Heading align="center" fontWeight="semibold" color="red.300" size="2xl">
                        Front-end
                    </Heading>
                    <Heading align="center" fontWeight="semibold" color="pink.300" size="2xl">
                        Back-end
                    </Heading>
                    <Text align="center" fontSize="xl" color="gray.400">Full-stack 개발 희망</Text>
                </Box>
        </Flex>
        <Flex direction={isSmallScreen ? "row" : "column"} w="100%"
        maxWidth={{base: "100vh", md:"100vh", lg: "100vh", xl: "100vh"}}>
            ...
            <Box alignSelf="center" w="100%">
                ...
                >
                    ...
                    <ListItem>
                        1992년 12월 12일생 (만 28세)
                    </ListItem>
                    <ListItem>
                        안양대학교 정보통신공학과 졸업(2017.02)
                    </ListItem>
                    <ListItem>
                        5년차 Front-end 개발자 (2016.11 입사)
                    </ListItem>
                    <ListItem>
                        새로운 도전을 좋아하는 열정이 넘치는 인재
                    </ListItem>
                    </UnorderedList>
                </Stack>
            </Box>
        ...
        <Image ml={5} borderRadius='3xl' zIndex="1" alignSelf="center" backgroundColor="transparent" w={200} h={200} src={Number(hour) >=8 && Number(hour) < 9 ? GohomeImage : Number(hour) >= 9 && Number(hour) < 18 ? OfficeImage : Number(hour) >= 18 && Number(hour) < 19 ? GohomeImage:HomeImage} />
